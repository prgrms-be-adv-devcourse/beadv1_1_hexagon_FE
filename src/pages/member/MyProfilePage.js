...
const MyProfilePage = () => {
    const [profile, setProfile] = useState({ nickname: '', email: '', currentWorkState: '' });
    ...
    if (loading) return <div className="p-8 text-center text-gray-600">내 정보 로딩 중...</div>;

    return (
        <div className="max-w-2xl mx-auto p-8 bg-white shadow-2xl rounded-xl">
            <h2 className="text-3xl font-bold mb-6 text-gray-800 border-b pb-2">👤 내 프로필 정보</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-500 p-3 bg-gray-100 rounded-lg">{profile.email}</p>
                </div>
