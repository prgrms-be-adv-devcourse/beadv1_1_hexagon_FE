...
export default function PaymentPage() {
    ...
    useEffect(() => {
        ...
        const fetchPaymentWidget = async () => {
            try {
                ...
                const paymentWidget = await loadPaymentWidget(widgetClientKey, customerKey.current);
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '600px', margin: 'auto' }}>
            <button onClick={() => navigate('/')} style={{ marginBottom: '20px', border:'none', background:'none', fontSize:'16px' }}>← 뒤로</button>
            <h1>결제 확인</h1>
